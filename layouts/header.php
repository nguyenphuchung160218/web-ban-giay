        ...
        <div id="wrapper">
            ...
            <div id="maincontent">
                <div class="container">
                    ...
                    <div style="border:1px solid #e3e3e3"><a href="index.php"><img style="width: 200px;height: auto;margin: 0 auto;display:flex;margin-bottom:20px" src="<?php echo base_url() ?>public/frontend/images/logo.png" alt=""></a></div>                
