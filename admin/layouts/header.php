        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <ul class="nav navbar-right top-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            <a href="<?php echo modules('admin') ?>"><i class="fa fa-fw fa-user"></i> Tài khoản</a>
                        </li>
                        <li class="divider"></li>
                        <li>
                            <a href="<?php echo base_url()?>login/checkout-admin.php"><i class="fa fa-fw fa-power-off"></i> Đăng xuất</a>
                        </li>
                    </ul>
                </li>
            </ul>
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav" style="font-size: 16px;">
                    <li>
                        <a href="<?php echo base_url()?>admin"><i class="fas fa-tachometer-alt"></i> Bảng Điều Khiển</a>
                    </li>
                    <li class="<?php echo isset($open) && $open =='category' ? 'active' :''; ?>">
                        <a href="<?php echo modules('category') ?>"><i class="fa fa-list"></i> Danh Mục</a>
                    </li>
                    <li class="<?php echo isset($open) && $open =='product' ? 'active' :''; ?>">
                        <a href="<?php echo modules('product') ?>"><i class="fa fa-shopping-cart"></i> Sản Phẩm</a>
                    </li>
                    <li class="<?php echo isset($open) && $open =='rating' ? 'active' :''; ?>">
                        <a href="<?php echo modules('rating') ?>"><i class="fa fa-comment"></i> Đánh Giá</a>
                    </li>
                    <li class="<?php echo isset($open) && $open =='transaction' ? 'active' :''; ?>">
                        <a href="<?php echo modules('transaction') ?>"><i class="fa fa-shopping-cart"></i> Đơn Hàng</a>
                    </li>
                    ...
                    <li class="<?php echo isset($open) && $open =='admin' ? 'active' :''; ?>">
                        <a href="<?php echo modules('admin') ?>"><i class="fa fa-user"></i> Quản Lý</a>
                    </li>
